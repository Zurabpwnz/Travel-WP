                                ...
                                <div class="entry">
                                    ...
                                    <div class="entry-content">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                            tempor incididunt ut labore et dolore magna aliqua. Aliquet nec ullamcorper
                                            sit amet risus. Posuere lorem ipsum dolor sit amet consectetur adipiscing.
                                        ...
                                        <div class="entry">
                                            <div class="entry-content">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                                    eiusmod tempor incididunt ut labore et dolore magna aliqua. Ac odio
                                                    tempor orci dapibus ultrices in iaculis nunc sed. Eu augue ut lectus
                                                    arcu bibendum...
                                                </p>
                                            </div>
                                            <div class="entry-meta-wrap clearfix">
                            ...
                            <div class="col-sm-6">
                                <article class="entry-item">
                                    ...
                                    <div class="entry-header">
                                        <a href="#" class="entry-category">Трэвел</a>
                                        <h2 class="entry-title">
                                            <a href="blog-single.html">Серфить в Португалии или фрирайдить на Красной
                                                Поляне?</a>
                                        </h2>
                                    </div>
                                    <div class="entry-wrap">
                                ...
                                <ul class="posts-list list-dividers">
                                    <li class="entry-li">
                                        <article class="post-small clearfix">
                                            ...
                                            <div class="entry">
                                                <h3 class="entry-title"><a href="magazine-single-article.html">Топ 5
                                                        горнолыжных курортов в Европе в 2020</a></h3>
                                    ...
                                    <li class="entry-li">
                                        <article class="post-small clearfix">
                                            ...
                                            <div class="entry">
                                                <h3 class="entry-title"><a href="magazine-single-article.html">Итальянская
                                                        кухня</a></h3>
                                                <ul class="entry-meta list-inline">
                                                    <li class="entry-date">
                                    ...
                                    <li class="entry-li">
                                        <article class="post-small clearfix">
                                            ...
                                            <div class="entry">
                                                <h3 class="entry-title"><a href="magazine-single-article.html">Рюкзаки
                                                        для путешетвий</a></h3>
                                                <ul class="entry-meta list-inline">
                                                    <li class="entry-date">
                                                        <a href="#">5 января 2020</a>
                                    ...
                                    <li class="entry-li">
                                        <article class="post-small clearfix">
                                            ...
                                            <div class="entry">
                                                <h3 class="entry-title"><a href="magazine-single-article.html">Новые
                                                        луки</a></h3>
                                                <ul class="entry-meta list-inline">
                                                    <li class="entry-date">
                                                        <a href="#">5 января 2020</a>
